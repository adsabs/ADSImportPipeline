...
class TestSolrAdapter(unittest.TestCase):
    ...
    def test_transform_json_record(self):
        ...
        self.assertEqual(out, {'abstract': u"all no-skysurvey q'i quotient",
             ...
             'links_data': [u'{"title":"", "type":"ned", "instances":"78", "access":""}',
                  u'{"title":"", "type":"postscript", "instances":"", "access":"open"}',
                  u'{"title":"", "type":"electr", "instances":"", "access":"open"}',
                  u'{"title":"", "type":"simbad", "instances":"74", "access":""}',
                  u'{"title":"", "type":"pdf", "instances":"", "access":"open"}'],
