...
class TestSolrAdapter(unittest.TestCase):
    ...
    def test_transform_json_record(self):
        ...
        self.assertEqual(out, {
             ...
             'links_data': [u'{"access": "", "instances": "78", "title": "", "type": "ned"}',
                  u'{"access": "open", "instances": "", "title": "", "type": "postscript"}',
                  u'{"access": "open", "instances": "", "title": "", "type": "electr"}',
                  u'{"access": "", "instances": "74", "title": "", "type": "simbad"}',
                  u'{"access": "open", "instances": "", "title": "", "type": "pdf"}'],
