...
INPUT_MONGO_DOC2={
    ...
    "metadata" : {
        ...
        'properties': {'refereed': False, 'openaccess': True, 
                   'doctype': {'content': u'article', 'origin': u'ADS metadata'}, 
                   'private': False, 'ocrabstract': False, 'ads_scan':False,
                   },
        "relations": {},
        "general" : {
            "publication" : {
